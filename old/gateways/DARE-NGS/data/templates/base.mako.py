...
_template_filename='/Users/Sharath/projects/projects/DARE-NGS/darengs/templates/base.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer('" type="text/css" media="screen" />\n<link rel="stylesheet" type="text/css" media="all" href="')
        # SOURCE LINE 8
        ...
        if flash_message:
            # SOURCE LINE 133
            __M_writer('     <div id="flash-message">')
