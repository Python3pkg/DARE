...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('darewap_darebigjobtask', 'pilot_url')

        # Adding field 'DareBigJobTask.cu_url'
        db.add_column('darewap_darebigjobtask', 'cu_url',
    ...
    def backwards(self, orm):
        ...
        db.add_column('darewap_darebigjobtask', 'pilot_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Deleting field 'DareBigJobTask.cu_url'
        db.delete_column('darewap_darebigjobtask', 'cu_url')
